var BASE_CONFIG_URL = "https://addonlist.com/api/v1/addons/apps/config";

var ADDONS_JSON_PATH = "addons.json";
var GIT_IGNORE_FILE_PATH = '.gitignore';
var GIT_IGNORE_TEXT = "# AddonList\r\n" + ADDONS_JSON_PATH + "\r\n";
...
fetchAndSetEnvVars = function() {
  ...
  request(options, function (error, response, body) {
    if (!error && response.statusCode == 200) {
      ...
      console.error("An unknown error has occured. Please contact support@addonlist.com.");
